...
Another goal is to keep the amount of flammable materials as low as possible. Powersupply and electronis are mounted in
the enclosure frame, but stay outside of the printing chamber.
