...
Keeping the amount of flammable materials as low as possible is a key objective. Having the external power brick stored in the 
frame is another one.  Powersupply and electronics stay outside of the printing chamber.
